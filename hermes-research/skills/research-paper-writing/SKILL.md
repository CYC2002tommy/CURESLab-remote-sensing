...
**Load the `arxiv` skill** for structured paper discovery: `Skill("arxiv")`. It provides arXiv REST API search, Semantic Scholar citation graphs, author profiles, and BibTeX generation.
...
|-------|-------------|-------------|
| **arxiv** | Phase 1 (Literature Review): searching arXiv, generating BibTeX, finding related papers via Semantic Scholar | `Skill("arxiv")` |
| **subagent-driven-development** | Phase 5 (Drafting): parallel section writing with 2-stage review (spec compliance then quality) | `Skill("subagent-driven-development")` |
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.hermes/plans/` | `Skill("plan")` |
...
| **diagramming** | Phase 4-5: creating Excalidraw-based figures and architecture diagrams | `Skill("diagramming")` |
| **data-science** | Phase 4 (Analysis): Jupyter live kernel for interactive analysis and visualization | `Skill("data-science")` |
...
| **`schedule`** | Schedule experiment monitoring, deadline countdowns, automated arXiv checks. |
...
Agent("Draft the Related Work section. Use web_search and web_extract to 
...
### Cron Monitoring with `schedule`

Use the `schedule` tool to schedule periodic experiment checks:
