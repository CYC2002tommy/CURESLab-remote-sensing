...
| **Security scan blocks** | Commands blocked by security | Use `execute_code` instead of piped `Bash` commands |
| **Delegation failures** | `Agent` returns errors | Fall back to doing work directly |
