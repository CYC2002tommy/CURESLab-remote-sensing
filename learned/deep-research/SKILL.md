...
## Reference Files
- `references/pause_and_discuss_protocol.md` - Strict 2-phase execution protocol: plan first, wait for explicit user approval, then execute autonomous data acquisition.
