...
### Custom Tools & Skill Authoring
If you need to write custom tools, see the developer guide online.
To author your own Hermes-Agent skills (in-repo), see `references/hermes-agent-skill-authoring.md`.

### Advanced Workflows & Patterns
For advanced operational patterns like UI-visible cron scheduling, profile isolation, and environment migrations (e.g. from `.hermes` to `AppData/Local/hermes`), see `references/hermes-advanced-workflows.md` and `references/hermes-advanced-patterns.md`.
