...
2. **Consult Sub-Skill**: Call the relevant `matlab-*` skill (e.g., use `skill_view(name="matlab-write-test")` if generating unit tests, or `matlab-debug-code` if diagnosing errors).
