...
## X-Axis Fractional Years (Decimal Ticks)
If plotting a single year or a short timeframe and Matplotlib creates decimal/fractional ticks (e.g., `2024.2`, `2024.4` instead of just `2024`), strictly enforce integer locators:
```python
