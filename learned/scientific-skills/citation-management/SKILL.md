...
#### Word Document (.docx) Citation Verification
For researchers drafting in Microsoft Word, you can extract and cross-reference in-text citations against the References list to find orphans, wrong years, and missing citations:
```bash
python scripts/verify_docx_citations.py manuscript.docx
```

#### Comprehensive BibTeX Validation
