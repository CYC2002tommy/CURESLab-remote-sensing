...
When instructed to reorganize, restructure, or edit sections of large LaTeX documents (e.g., academic papers >300 lines), **avoid full-file rewrites** using `write_file` or basic text replacements, as they risk breaking complex formatting, dropping equations, or hallucinating content.
